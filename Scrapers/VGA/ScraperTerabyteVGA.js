          ...
          new Promise(async (resolve, reject) => {
            let results = await page.evaluate((resolve, reject) => {
              ...
              document.querySelectorAll("div.pbox").forEach((result) => {
                ...
                const isAvailable =
                  result.getElementsByClassName("tbt_esgotado").length === 0;
                ...
                if (!isAvailable) {
                  ...
                  const productValue = result
                    ...
                    .replace(".", "")
                    .replace(",", ".");
                  const productValueInstallmentsString = result
                    .getElementsByClassName("prod-juros")[0]
                    .getElementsByTagName("span")[1].innerText;
                  const productLink = result
                    .getElementsByClassName("prod-name")[0]
                    .getAttribute("href");
